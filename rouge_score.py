...
# Calculate ROUGE for each reference caption
for i in range(len(references)):
    scores = rouge.get_scores(str(predictions[i]), str(references[i]))
...
num_predictions = len(scores_list)
for key in avg_scores:
    avg_scores[key]['f'] /= num_predictions
    avg_scores[key]['p'] /= num_predictions
    avg_scores[key]['r'] /= num_predictions
