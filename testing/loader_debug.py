...
from datasets import Kinetics, DinoLossLoader, KineticsFinetune, FrameSelectionLoader
import torch
...
if __name__ == '__main__':
    ...
    #dataset = DinoLossLoader(cfg=config, mode="test", local_clip_size=3, global_clip_size=60)
    dataset = FrameSelectionLoader(cfg=config, mode="test", loss_file="/home/reutemann/Dino-Video-Summarization-Transformer/loss_values/loss_kinetics_test_4_3_30.json", pre_sampling_rate=2, selection_method="adaptive")
